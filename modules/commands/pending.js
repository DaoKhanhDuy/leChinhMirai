...
module.exports.handleReply = async function({ api, event, handleReply, getText }) {
    ...
    if (isNaN(body) && body.indexOf("c") == 0 || body.indexOf("cancel") == 0) {
        ...
        for (const singleIndex of index) {
            ...
            api.sendMessage("", event.threadID, () => api.sendMessage({body:`》 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐂𝐨𝐧𝐧𝐞𝐜𝐭𝐞𝐝 《\n𝑩𝒐𝒕 𝒊𝒔 𝒐𝒑𝒆𝒓𝒂𝒕𝒊𝒏𝒈 𝒃𝒚 Chinhle\n𝐂𝐨𝐧𝐭𝐚𝐜𝐭: https://www.facebook.com/Chinhle3601-fb Đặng Thị Kim Linh - fb.me/kiimlid, 𝑪𝒉𝒖́𝒄 𝒄𝒂́𝒄 𝒃𝒂̣𝒏 𝒕𝒓𝒂̉𝒊 𝒏𝒈𝒉𝒊𝒆̣̂𝒎 𝒃𝒐𝒕 𝒗𝒖𝒊 𝒗𝒆̉ 𝒗𝒂̀ 𝒌𝒉𝒐̂𝒏𝒈 𝒔𝒑𝒂𝒎, 𝒑𝒉𝒂́ 𝒃𝒐𝒕 𝒅𝒖̛𝒐̛́𝒊 𝒎𝒐̣𝒊 𝒉𝒊̀𝒏𝒉 𝒕𝒉𝒖̛́𝒄\n 𝑴𝑨̃𝑰 𝑰𝑼 𝑼𝑾𝑼🐧❤ `, attachment: fs.createReadStream(__dirname + "/cache/pending/pending.mp4")} ,handleReply.pending[singleIndex - 1].threadID));
            count+=1;
