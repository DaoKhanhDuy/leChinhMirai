...
async function low(link,api,event) {
    var axios = require('axios'); 
        var out = (msg) => api.sendMessage(msg,event.threadID,event.messageID);
            try {
                var { data } = await axios.get(`http://api.leanhtruong.net/api/xvideos?url=${link}&apikey=LEANHTRUONG=WOClDtFQdvD7GI5B2u3Z4JO8cU2dhQlj9IzeMM4AysykJC9Zqa=APIKEY=PLANFREE`);
